...
message(sprintf("Average monthly water temperature for Sacramento San Joaquin Delta in %s is %.2f°F\nand the historical average for %s is %.2f°F",
                SacSanJoaquin_current_month, SacSanJoaquin_waterTemp_monthly_average, 
                SacSanJoaquin_current_month,
                SacSanJoaquin_current_month_historical_mean))
